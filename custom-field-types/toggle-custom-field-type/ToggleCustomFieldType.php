...
if ( ! class_exists( 'SpiderSEOToggleCustomFieldType' ) ) :
/**
 ...
 */
class SpiderSEOToggleCustomFieldType extends SpiderSEOAdminPageFramework_FieldType_checkbox {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.spider-seo-field' )
                    .children( '.spider-seo-checkbox-container-toggle' )
                    .hide();
