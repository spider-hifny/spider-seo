<?php
if ( ! class_exists( 'SpiderSEOGitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class SpiderSEOGitHubCustomFieldType extends SpiderSEOAdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='spider-seo-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='spider-seo-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'spider-seo' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'spider-seo' );
                case 'star':
                    return __( 'Star', 'spider-seo' );
                case 'fork':
                    return __( 'Fork', 'spider-seo' );
                case 'issue':
                    return __( 'Issue', 'spider-seo' );
                default:
                    return '';
            }                 
