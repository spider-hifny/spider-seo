<?php
/**
 * SpiderSEOAceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'SpiderSEOAceCustomFieldType' ) ) :
class SpiderSEOAceCustomFieldType extends SpiderSEOAdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.spider-seo-field' ).nextAll().andSelf().each( function( iIndex ) {
