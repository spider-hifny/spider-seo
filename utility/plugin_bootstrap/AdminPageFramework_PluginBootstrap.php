...
abstract class SpiderSEOAdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    {
        if (! class_exists('SpiderSEOAdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new SpiderSEOAdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
