...
class SpiderSEOAdminPageFramework_PointerToolTip extends SpiderSEOAdminPageFramework_FrameworkUtility {
    ...
    {
        echo "<script type='text/javascript' class='spider-seo-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->___getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
