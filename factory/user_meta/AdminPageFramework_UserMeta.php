...
abstract class SpiderSEOAdminPageFramework_UserMeta extends SpiderSEOAdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability='read', $sTextDomain='spider-seo')
    {
