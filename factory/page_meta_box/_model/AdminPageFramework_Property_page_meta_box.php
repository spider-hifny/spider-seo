...
class SpiderSEOAdminPageFramework_Property_page_meta_box extends SpiderSEOAdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability='manage_options', $sTextDomain='spider-seo', $sStructureType='page_meta_box')
    {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS[ 'aSpiderSEOAdminPageFramework' ][ 'aMetaBoxForPagesClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aSpiderSEOAdminPageFramework', 'aMetaBoxForPagesClasses' ));
        $GLOBALS[ 'aSpiderSEOAdminPageFramework' ][ 'aMetaBoxForPagesClasses' ][ $sClassName ] = $oCaller;
    }
    ...
    {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array( 'aSpiderSEOAdminPageFramework', 'aPageClasses' ));
