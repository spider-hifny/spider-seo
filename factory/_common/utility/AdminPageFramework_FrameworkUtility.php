...
class SpiderSEOAdminPageFramework_FrameworkUtility extends SpiderSEOAdminPageFramework_WPUtility {
    ...
    {
        $_sVersion = SpiderSEOAdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    public static function getFrameworkName()
    {
        return SpiderSEOAdminPageFramework_Registry::NAME;
    }
