...
abstract class SpiderSEOAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array( 'oForm' => 'SpiderSEOAdminPageFramework_Form_', 'oPageLoadInfo' => 'SpiderSEOAdminPageFramework_PageLoadInfo_', 'oResource' => 'SpiderSEOAdminPageFramework_Resource_', 'oHelpPane' => 'SpiderSEOAdminPageFramework_HelpPane_', 'oLink' => 'SpiderSEOAdminPageFramework_Link_', );
    private $_aSubClassNames = array( 'oProp' => null, 'oDebug' => 'SpiderSEOAdminPageFramework_Debug', 'oUtil' => 'SpiderSEOAdminPageFramework_FrameworkUtility', 'oMsg' => 'SpiderSEOAdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null, );
    ...
    {
        trigger_error(SpiderSEOAdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString()
    {
        return SpiderSEOAdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
