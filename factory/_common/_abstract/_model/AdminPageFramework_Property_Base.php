...
abstract class SpiderSEOAdminPageFramework_Property_Base extends SpiderSEOAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType)
    {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'spider-seo' : $sTextDomain;
    ...
    {
        if (! isset($GLOBALS[ 'aSpiderSEOAdminPageFramework' ])) {
            $GLOBALS[ 'aSpiderSEOAdminPageFramework' ] = array( 'aFieldFlags' => array() );
        }
    }
    ...
    {
        self::$_aLibraryData = array( 'sName' => SpiderSEOAdminPageFramework_Registry::NAME, 'sURI' => SpiderSEOAdminPageFramework_Registry::URI, 'sScriptName' => SpiderSEOAdminPageFramework_Registry::NAME, 'sLibraryName' => SpiderSEOAdminPageFramework_Registry::NAME, 'sLibraryURI' => SpiderSEOAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => SpiderSEOAdminPageFramework_Registry::getVersion(), 'sDescription' => SpiderSEOAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => SpiderSEOAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => SpiderSEOAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => SpiderSEOAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => SpiderSEOAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '', );
    ...
    public function __get($sName)
    {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new SpiderSEOAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
