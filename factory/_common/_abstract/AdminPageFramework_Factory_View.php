...
abstract class SpiderSEOAdminPageFramework_Factory_View extends SpiderSEOAdminPageFramework_Factory_Model {
    public function __construct($oProp)
    {
        parent::__construct($oProp);
        new SpiderSEOAdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
