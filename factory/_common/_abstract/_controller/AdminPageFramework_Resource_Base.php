...
abstract class SpiderSEOAdminPageFramework_Resource_Base extends SpiderSEOAdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'spider-seo-style';
    protected $_sClassSelector_Script = 'spider-seo-script';
    ...
    {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array( "style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}", ), SpiderSEOAdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName)
    {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array( "script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}", ), SpiderSEOAdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle()
    {
        ...
        $this->_printCommonStyles('spider-seo-style-common', get_class());
    ...
    public function _replyToAddScript()
    {
        ...
        $this->_printCommonScripts('spider-seo-script-common', get_class());
    ...
    public function _replyToEnqueueCommonStyles()
    {
        ...
        $this->_addEnqueuingResourceByType(SpiderSEOAdminPageFramework_Registry::$sDirPath . '/factory/_common/asset/css/common.css', array( 'version' => SpiderSEOAdminPageFramework_Registry::VERSION, ), 'style');
    }
