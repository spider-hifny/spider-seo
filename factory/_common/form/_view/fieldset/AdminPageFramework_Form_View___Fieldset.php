...
class SpiderSEOAdminPageFramework_Form_View___Fieldset extends SpiderSEOAdminPageFramework_Form_View___Fieldset_Base {
    public function get()
    {
        $_aOutputs = array();
        $_oFieldError = new SpiderSEOAdminPageFramework_Form_View___Fieldset___FieldError($this->aErrors, $this->aFieldset[ '_section_path_array' ], $this->aFieldset[ '_field_path_array' ], $this->aFieldset[ 'error_message' ]);
        $_aOutputs[] = $_oFieldError->get();
        $_oFieldsFormatter = new SpiderSEOAdminPageFramework_Form_Model___Format_Fields($this->aFieldset, $this->aOptions);
    ...
    private function ___getEachFieldOutput($aField, $isIndex, array $aCallbacks, $bIsLastElement=false)
    {
        ...
        $_oSubFieldFormatter = new SpiderSEOAdminPageFramework_Form_Model___Format_EachField($aField, $isIndex, $aCallbacks, $_aFieldTypeDefinition);
    ...
    {
        $_oFieldAttribute = new SpiderSEOAdminPageFramework_Form_View___Attribute_Field($aField);
    ...
    {
        $_oFieldsetAttributes = new SpiderSEOAdminPageFramework_Form_View___Attribute_Fieldset($aFieldset);
    ...
    private function ___getEmbeddedFieldTitle($aFieldset)
    {
        ...
        $_oFieldTitle = new SpiderSEOAdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aOptions, $this->aErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
    ...
    private function ___getChildFieldTitle($aFieldset)
    {
        ...
        $_oFieldTitle = new SpiderSEOAdminPageFramework_Form_View___FieldTitle($aFieldset, array( 'spider-seo-child-field-title' ), $this->aOptions, $this->aErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        return $_oFieldTitle->get();
    }
    private function ___getFieldsetContent($aFieldset, $aFieldsOutput, $iFieldsCount)
    {
        ...
        $_oFieldsAttributes = new SpiderSEOAdminPageFramework_Form_View___Attribute_Fields($aFieldset, array(), $iFieldsCount);
    ...
    {
        $_aOutput = array();
        $_oFieldDescription = new SpiderSEOAdminPageFramework_Form_View___Description($aField[ 'description' ], 'spider-seo-fields-description');
