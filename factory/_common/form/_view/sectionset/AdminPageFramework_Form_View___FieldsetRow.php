...
class SpiderSEOAdminPageFramework_Form_View___FieldsetRow extends SpiderSEOAdminPageFramework_Form_View___FieldsetTableRow {
    ...
    public function get()
    {
        ...
        $_oFieldrowAttribute = new SpiderSEOAdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
