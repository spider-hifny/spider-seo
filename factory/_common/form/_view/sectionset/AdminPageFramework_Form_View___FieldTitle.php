...
class SpiderSEOAdminPageFramework_Form_View___FieldTitle extends SpiderSEOAdminPageFramework_Form_Utility {
    ...
    public function get()
    {
        ...
        $_oInputTagIDGenerator = new SpiderSEOAdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
        $_aLabelAttributes = array( 'class' => $this->getClassAttribute('spider-seo-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(), );
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField)
    {
        ...
        foreach ($aField[ 'content' ] as $_aNestedField) {
            ...
            $_oFieldset = new SpiderSEOAdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
    ...
    {
        $_oToolTip = new SpiderSEOAdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
