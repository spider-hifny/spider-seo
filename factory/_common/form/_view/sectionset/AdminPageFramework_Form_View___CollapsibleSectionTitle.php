...
class SpiderSEOAdminPageFramework_Form_View___CollapsibleSectionTitle extends SpiderSEOAdminPageFramework_Form_View___SectionTitle {
    ...
    private function ___enqueueScript()
    {
        ...
        $_oForm->addResource('src_scripts', array( 'handle_id' => 'spider-seo-script-form-collapsible-sections', ));
    }
    private function ___getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer='sections', $iSectionIndex=null)
    {
        ...
        return "<div " . $this->getAttributes(array( 'id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('spider-seo-section-title', $this->getAOrB('box' === $aCollapsible[ 'type' ], 'accordion-section-title', ''), 'spider-seo-collapsible-title', $this->getAOrB('sections' === $aCollapsible[ 'container' ], 'spider-seo-collapsible-sections-title', 'spider-seo-collapsible-section-title'), $this->getAOrB($aCollapsible[ 'is_collapsed' ], 'collapsed', ''), 'spider-seo-collapsible-type-' . $aCollapsible[ 'type' ]), ) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
    }
}
