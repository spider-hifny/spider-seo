...
class SpiderSEOAdminPageFramework_Form_View___Description extends SpiderSEOAdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'spider-seo-form-element-description';
