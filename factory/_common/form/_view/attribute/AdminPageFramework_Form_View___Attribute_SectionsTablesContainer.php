...
class SpiderSEOAdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends SpiderSEOAdminPageFramework_Form_View___Attribute_Base {
    ...
    {
        return array( 'id' => $this->sSectionsID, 'class' => $this->getClassAttribute('spider-seo-sections', $this->getAOrB(! $this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'spider-seo-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'spider-seo-collapsible-sections-content' . ' ' . 'spider-seo-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset[ 'repeatable' ]), null, 'repeatable-section'), $this->getAOrB(empty($this->aSectionset[ 'sortable' ]), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset[ 'section_id' ], 'data-section_address' => $this->aSectionset[ 'section_id' ], 'data-section_address_model' => $this->aSectionset[ 'section_id' ] . '|' . '___i___', ) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset)
    {
        ...
        $_oSectionNameGenerator = new SpiderSEOAdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset[ '_caller_object' ]->aCallbacks[ 'hfSectionName' ]);
