...
class SpiderSEOAdminPageFramework_Form_View___ToolTip extends SpiderSEOAdminPageFramework_Form_View___Section_Base {
    ...
    public function get()
    {
        ...
        return "<span " . $this->___getElementAttributes('container', array( 'spider-seo-form-tooltip', 'no-js' ), $_aAttributes) . ">" . $this->___getTipIcon() . "<span " . $this->___getElementAttributes('content', 'spider-seo-form-tooltip-content') . ">" . $this->___getTipTitle() . $this->___getDescriptions() . "</span>" . "</span>" ;
    }
    ...
    private function ___getTipTitle()
    {
        if (isset($this->aArguments[ 'title' ])) {
            return "<span " . $this->___getElementAttributes('title', 'spider-seo-form-tooltip-title') . ">" . $this->aArguments[ 'title' ] . "</span>";
        }
        return '';
    }
    private function ___getDescriptions()
    {
        if (isset($this->aArguments[ 'content' ])) {
            return "<span " . $this->___getElementAttributes('description', 'spider-seo-form-tooltip-description') . ">" . implode("</span><span " . $this->___getElementAttributes('description', 'spider-seo-form-tooltip-description') . ">", $this->getAsArray($this->aArguments[ 'content' ])) . "</span>" ;
        }
        return '';
    }
