...
var apfMedia = SpiderSEOAdminPageFrameworkMediaFieldType;
...
(function ( $ ) {
  ...
  var setSpiderSEOAdminPageFrameworkMediaUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfMedia.hasMediaUploader ) {
       ...
       */
      setSpiderSEOAdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMedia.on( 'click', function () {
          ...
          window.send_to_editor = hfSpiderSEOAdminPageFrameworkSendToEditorMedia;
      ...
      var hfSpiderSEOAdminPageFrameworkSendToEditorMedia = function ( sRawHTML, param ) {
      ...
      setSpiderSEOAdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMediaButton.on( 'click', function ( e ) {
          ...
          oSpiderSEOAdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;

          // Assign a custom select object.
          wp.media.view.MediaFrame.Select = fExternalSource ? getSpiderSEOAdminPageFrameworkCustomMediaUploaderSelectObject() : oSpiderSEOAdminPageFrameworkOriginalMediaUploaderSelectObject;
          ...
          _oMediaUploader.on( 'close', function () {
            ...
            wp.media.view.MediaFrame.Select = oSpiderSEOAdminPageFrameworkOriginalMediaUploaderSelectObject;
    ...
    $( document ).ready( function () {
      ...
      $( 'a.select_media.button' ).each( function() {
        setSpiderSEOAdminPageFrameworkMediaUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
      } );
      ...
      $().registerSpiderSEOAdminPageFrameworkCallbacks( {
          ...
          repeated_field: function ( oCloned, aModel ) {
            ...
            setSpiderSEOAdminPageFrameworkMediaUploader(
