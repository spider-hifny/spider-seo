...
( function( $ ){
  ...
  var apfRadio = SpiderSEOAdminPageFrameworkFieldTypeRadio;
  ...
  $( document ).ready( function(){
    ...
    $( 'input[type=radio].spider-seo-input-radio' ).on( 'change', function ( e ) {

      var _sInputID = $( this ).data( 'id' );
      // Uncheck the other radio buttons
      $( this ).closest( '.spider-seo-field' ).find( 'input[type=radio][data-id="' + _sInputID + '"]' )
        .prop( 'checked', false )
        .attr( 'checked', false );
    ...
    $().registerSpiderSEOAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
          oCloned.find( 'input[type=radio].spider-seo-input-radio' )
            .off( 'change' )
