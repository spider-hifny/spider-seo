...
class SpiderSEOAdminPageFramework_FieldType_contact extends SpiderSEOAdminPageFramework_FieldType_submit {
    public $aFieldTypeSlugs = array( 'contact', );
    private $___sAction = 'spider-seo_contact_field_type_email';
    ...
    {
        return array( array( 'handle_id' => 'spider-seo-field-type-contact', 'src' => dirname(__FILE__) . '/js/contact.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'spider-seo-script-form-main' ), 'translation_var' => 'SpiderSEOAdminPageFrameworkContactFieldType', 'translation' => array( 'nonce' => wp_create_nonce(get_class($this)), 'action' => $this->___sAction, 'messages' => array( 'requiredField' => $this->oMsg->get('please_fill_out_this_field'), ), ), ), );
    }
    ...
    private function ___doAjaxResponse()
    {
        ...
        $_oEmail = new SpiderSEOAdminPageFramework_FormEmail($_aEmailOptions, $_aInputs, $_sSubmitSectionID);
