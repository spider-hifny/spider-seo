...
(function ( $ ) {
  ...
  var apfColor = SpiderSEOAdminPageFrameworkColorFieldType;

  var registerSpiderSEOAdminPageFrameworkColorPickerField = function ( osSubjectInput, aOptions ) {
    ...
    var _aDefaults = {
      ...
      change: function ( event, ui ) {
        $( osTargetInput ).trigger( 'spider-seo_field_type_color_changed' );
      ...
      clear: function ( event, ui ) {
        $( osTargetInput ).trigger( 'spider-seo_field_type_color_cleared' );
  ...
  $( document ).ready( function () {
    ...
    // Initialization
    $( '.spider-seo-field-color-picker' ).each( function () {
      registerSpiderSEOAdminPageFrameworkColorPickerField( $( this ).data( 'input_id' ) );
    } );
    ...
    $().registerSpiderSEOAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          oCloned.find( 'input.input_color' ).each( function ( iIterationIndex ) {
            ...
            registerSpiderSEOAdminPageFrameworkColorPickerField( _oNewColorInput );
