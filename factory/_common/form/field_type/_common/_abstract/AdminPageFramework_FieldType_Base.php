...
abstract class SpiderSEOAdminPageFramework_FieldType_Base extends SpiderSEOAdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName='admin_page_framework', $asFieldTypeSlug=null, $oMsg=null, $bAutoRegister=true)
    {
        ...
        $this->oMsg = $oMsg ? $oMsg : SpiderSEOAdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset)
    {
        ...
        $_oFieldset = new SpiderSEOAdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    {
        wp_enqueue_media();
        wp_enqueue_script('spider-seo-script-form-media-uploader');
    }
