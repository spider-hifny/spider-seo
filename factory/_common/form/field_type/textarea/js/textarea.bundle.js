...
(function($){
  ...
  /** global: SpiderSEOAdminPageFrameworkFieldTypeTextArea */
  var apfTextArea = SpiderSEOAdminPageFrameworkFieldTypeTextArea;
  ...
  $( document ).ready( function(){
    ...
    var updateFoundEditors = function ( oElements ) {
      ...
      oElements.each( function ( iIndex ) {
        ...
        var oSettings = $().getSpiderSEOAdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );
    ...
    $().registerSpiderSEOAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          var _oSettings = $().getSpiderSEOAdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );

          // Elements
          var _oField = oCloned.closest( '.spider-seo-field' );
        ...
        stopped_sorting_fields: function ( oSortedFields, sFieldType, sFieldsTagID, iCallType ) {
          ...
          // Update the editor.
          setTimeout( function () {
            var _oFields = oSortedFields.children( '.spider-seo-field' );
        ...
        stopped_sorting_sections: function ( oSections ) {
          ...
          setTimeout( function () {
            var _oFields = $( oSections ).find( '.spider-seo-field' );
            updateFoundEditors( _oFields );
          }, 100 );
        ...
        saved_widget: function ( oWidget ) {
          ...
          $( oWidget ).find( '.spider-seo-field' ).each( function ( iIndex ) {
            ...
            // Store the settings.
            $().storeSpiderSEOAdminPageFrameworkInputOptions(
              oWrap.attr( 'data-id' ),
              {
    ...
    // Initialize
    $( '.spider-seo-textarea-data-input' ).each( function(){
