...
(function($){
  ...
  var apfTaxonomy = SpiderSEOAdminPageFrameworkFieldTypeTaxonomy;
  ...
  $( document ).ready( function(){
    ...
    /* For tabs */
    var enableSpiderSEOAdminPageFrameworkTabbedBox = function ( nodeTabBoxContainer ) {
    ...
    enableSpiderSEOAdminPageFrameworkTabbedBox( $( '.tab-box-container' ) );
    ...
    $().registerSpiderSEOAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Initialize
          enableSpiderSEOAdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
