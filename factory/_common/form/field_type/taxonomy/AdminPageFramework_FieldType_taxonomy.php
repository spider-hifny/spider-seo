...
class SpiderSEOAdminPageFramework_FieldType_taxonomy extends SpiderSEOAdminPageFramework_FieldType_checkbox {
    ...
    {
        return array( array( 'handle_id' => 'spider-seo-field-type-taxonomy', 'src' => dirname(__FILE__) . '/js/taxonomy.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'spider-seo-script-form-main' ), 'translation_var' => 'SpiderSEOAdminPageFrameworkFieldTypeTaxonomy', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
