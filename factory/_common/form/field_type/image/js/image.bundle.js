...
var apfImage = SpiderSEOAdminPageFrameworkImageFieldType;
apfImage.hasMediaUploader = !! apfImage.hasMediaUploader;
(function ( $ ) {

  var setSpiderSEOAdminPageFrameworkImageUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfImage.hasMediaUploader ) {
       ...
       */
      setSpiderSEOAdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function () {
          ...
          window.send_to_editor = hfSpiderSEOAdminPageFrameworkSendToEditorImage;
      ...
      var hfSpiderSEOAdminPageFrameworkSendToEditorImage = function ( sRawHTML ) {
      ...
      setSpiderSEOAdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function ( e ) {
          ...
          oSpiderSEOAdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
          // Assign a custom select object
          wp.media.view.MediaFrame.Select = fExternalSource ? getSpiderSEOAdminPageFrameworkCustomMediaUploaderSelectObject() : oSpiderSEOAdminPageFrameworkOriginalImageUploaderSelectObject;
          ...
          _oCustomImageUploader.on( 'close', function () {
            ...
            if ( typeof (_oImage) !== 'undefined' ) {
              ...
              _oCustomImageUploader.state().get( 'selection' ).each( function ( oAttachment, iIndex ) {
                ...
                var _oFieldContainer = 'undefined' === typeof _oNewField
                  ? $( '#' + sInputID ).closest( '.spider-seo-field' )
                  : _oNewField;
                _oNewField = $( this ).addSpiderSEOAdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oSpiderSEOAdminPageFrameworkOriginalImageUploaderSelectObject;
    ...
    $().registerSpiderSEOAdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Bind the event.
          var _oFieldContainer = oCloned.closest( '.spider-seo-field' );
          ...
          setSpiderSEOAdminPageFrameworkImageUploader(
    ...
    $( '.select_image.button' ).each( function() {
      setSpiderSEOAdminPageFrameworkImageUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
    } );
    // Remove buttons
