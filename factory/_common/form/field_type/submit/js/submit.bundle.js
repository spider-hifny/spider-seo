...
(function($){
  ...
  $( document ).ready( function(){
    ...
    $( '.spider-seo-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
      $( this ).closest( '.spider-seo-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
        var _fieldSubmit = $( this ).closest( '.spider-seo-field-submit' );
        _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
        var _confirmCheckbox = $( this ).closest( '.spider-seo-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
