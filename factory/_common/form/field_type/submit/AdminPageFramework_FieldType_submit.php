...
class SpiderSEOAdminPageFramework_FieldType_submit extends SpiderSEOAdminPageFramework_FieldType {
    ...
    {
        return array( array( 'handle_id' => 'spider-seo-submit-field-type', 'src' => dirname(__FILE__) . '/js/submit.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', ), ), );
    }
    ...
    {
        return array( 'style' => $aField[ 'label_min_width' ] || '0' === ( string ) $aField[ 'label_min_width' ] ? "min-width:" . $this->getLengthSanitized($aField[ 'label_min_width' ]) . ";" : null, 'class' => 'spider-seo-input-label-container' . ' spider-seo-input-button-container' . ' spider-seo-input-container', );
    }
