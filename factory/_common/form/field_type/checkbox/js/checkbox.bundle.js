...
(function($){
  ...
  var apfCheckBox = SpiderSEOAdminPageFrameworkFieldTypeCheckbox;
  ...
  $( document ).ready( function(){
    ...
    $( document ).ready( function(){
      ...
      _body.on( 'click', '.select_all_button_container', function() {
        $( this ).selectAllSpiderSEOAdminPageFrameworkCheckboxes();
        return false;
      } );
      ...
      _body.on( 'click', '.select_none_button_container', function() {
        $( this ).deselectAllSpiderSEOAdminPageFrameworkCheckboxes();
        return false;
      } );
    });
