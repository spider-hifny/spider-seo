...
class SpiderSEOAdminPageFramework_Form_Model___FormatSectionset extends SpiderSEOAdminPageFramework_Form_Utility {
    ...
    public function get()
    {
        ...
        $_oCollapsibleArgumentFormatter = new SpiderSEOAdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset[ 'collapsible' ], $_aSectionset[ 'title' ]);
