...
class SpiderSEOAdminPageFramework_Form_Model___Format_Fieldset extends SpiderSEOAdminPageFramework_Form_Model___Format_FormField_Base {
    ...
    private function _getChildFieldsetsFormatted(array $aNestedFieldsets, array $aParentFieldset)
    {
        ...
        foreach ($aNestedFieldsets as $_isIndex => &$_aNestedFieldset) {
            ...
            $_oFieldsetFormatter = new SpiderSEOAdminPageFramework_Form_Model___Format_Fieldset($_aNestedFieldset + $_aInheritingFieldsetValues, $this->sStructureType, $this->sCapability, $this->iCountOfElements, $this->iSubSectionIndex, $this->bIsSectionRepeatable, $this->oCallerObject);
