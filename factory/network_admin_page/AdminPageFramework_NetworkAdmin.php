...
abstract class SpiderSEOAdminPageFramework_NetworkAdmin extends SpiderSEOAdminPageFramework {
    ...
    public function __construct($sOptionKey=null, $sCallerPath=null, $sCapability='manage_network', $sTextDomain='spider-seo')
    {
        if (! $this->_isInstantiatable()) {
            return;
        }
        $sCallerPath = $sCallerPath ? $sCallerPath : SpiderSEOAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new SpiderSEOAdminPageFramework_Model_Menu__RegisterMenu($this, 'network_admin_menu');
    }
    ...
    {
        return SpiderSEOAdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
