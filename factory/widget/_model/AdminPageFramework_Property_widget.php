...
class SpiderSEOAdminPageFramework_Property_widget extends SpiderSEOAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability='manage_options', $sTextDomain='spider-seo', $sStructureType='')
    {
