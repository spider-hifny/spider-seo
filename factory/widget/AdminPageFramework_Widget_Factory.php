...
class SpiderSEOAdminPageFramework_Widget_Factory extends WP_Widget {
    public $oCaller;
    public function __construct($oCaller, $sWidgetTitle, array $aArguments=array())
    {
        $aArguments = $aArguments + array( 'classname' => 'spider-seo-widget admin_page_framework_widget', 'description' => '', );
    ...
    public function form($aSavedFormData)
    {
        ...
        $this->oCaller->oForm = new SpiderSEOAdminPageFramework_Form_widget(array( 'register_if_action_already_done' => false, ) + $this->oCaller->oProp->aFormArguments, $this->oCaller->oForm->aCallbacks, $this->oCaller->oMsg);
