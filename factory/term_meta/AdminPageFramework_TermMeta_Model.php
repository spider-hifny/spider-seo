...
abstract class SpiderSEOAdminPageFramework_TermMeta_Model extends SpiderSEOAdminPageFramework_TermMeta_Router {
    ...
    {
        $_oMetaData = new SpiderSEOAdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
