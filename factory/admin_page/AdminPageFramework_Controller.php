...
abstract class SpiderSEOAdminPageFramework_Controller extends SpiderSEOAdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector='error', $sID='')
    {
        ...
        new SpiderSEOAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[ $sID ][ 'sMessage' ], $this->oProp->aAdminNotices[ $sID ][ 'aAttributes' ], array( 'should_show' => array( $this, 'isInThePage' ), ));
    }
    ...
    {
        return SpiderSEOAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
