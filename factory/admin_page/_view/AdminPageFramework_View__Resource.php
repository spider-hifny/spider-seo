...
class SpiderSEOAdminPageFramework_View__Resource extends SpiderSEOAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    {
        $_oFormatter = new SpiderSEOAdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    {
        $_oFormatter = new SpiderSEOAdminPageFramework_Format_PageResource_Script($asPageScript);
