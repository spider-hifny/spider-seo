...
class SpiderSEOAdminPageFramework_View__PageRenderer__PageHeadingTabs extends SpiderSEOAdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    {
        $_oTabBar = new SpiderSEOAdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array( ), array( 'format' => array( $this, '_replyToFormatNavigationTabItem_PageHeadingTab' ), ));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='spider-seo-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
