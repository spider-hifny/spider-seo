...
abstract class SpiderSEOAdminPageFramework_Model_Form extends SpiderSEOAdminPageFramework_Router {
    public $aFieldErrors;
    ...
    {
        new SpiderSEOAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
