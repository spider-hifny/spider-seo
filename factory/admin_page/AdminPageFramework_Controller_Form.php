...
abstract class SpiderSEOAdminPageFramework_Controller_Form extends SpiderSEOAdminPageFramework_View_Form {
    ...
    public function getValue()
    {
        ...
        return SpiderSEOAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
