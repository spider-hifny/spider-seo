...
abstract class SpiderSEOAdminPageFramework_Router extends SpiderSEOAdminPageFramework_Factory {
    public $oProp;
    public $oForm;
    ...
    public function _replyToLoadComponentsForAjax()
    {
        ...
        new SpiderSEOAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
