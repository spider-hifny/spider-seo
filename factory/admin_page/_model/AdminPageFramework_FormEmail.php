...
class SpiderSEOAdminPageFramework_FormEmail extends SpiderSEOAdminPageFramework_FrameworkUtility {
    ...
    public function send()
    {
        ...
        do_action('spider-seo_action_before_sending_form_email', $_aEmailOptions, $_aInputs, $_sSubmitSectionID);
        ...
        do_action('spider-seo_action_after_sending_form_email', $_bSent, $_aEmailOptions);
