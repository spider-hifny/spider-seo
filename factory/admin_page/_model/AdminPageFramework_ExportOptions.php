...
class SpiderSEOAdminPageFramework_ExportOptions extends SpiderSEOAdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
    ...
    private function _outputDataByType($vData, $sFormatType)
    {
        switch (strtolower($sFormatType)) { case 'text': if (in_array(gettype($vData), array( 'array', 'object' ))) {
            echo SpiderSEOAdminPageFramework_Debug::get($vData, null, false);
