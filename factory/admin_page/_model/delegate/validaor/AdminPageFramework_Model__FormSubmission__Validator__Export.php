...
class SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Export extends SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Import {
    ...
    {
        $_oExport = new SpiderSEOAdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array( '__export' ))), $this->oFactory->oProp->sClassName);
