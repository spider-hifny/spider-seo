...
class SpiderSEOAdminPageFramework_Model__FormSubmission__Validator extends SpiderSEOAdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory)
    {
        ...
        $_aClassNames = array( 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Link', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Import', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Export', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Reset', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm', );
        ...
        try {
            ...
            $_oFormSubmissionFilter = new SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
