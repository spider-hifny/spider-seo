...
class SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__ContactForm extends SpiderSEOAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function ___sendEmail($aInputs, $sPressedInputNameFlat, $sSubmitSectionID)
    {
        ...
        $_oEmail = new SpiderSEOAdminPageFramework_FormEmail($_aEmailOptions, $aInputs, $sSubmitSectionID);
        $_bSent = $_oEmail->send();
