...
class SpiderSEOAdminPageFramework_Model__FormSubmission__Validator__Import extends SpiderSEOAdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    {
        $_oImport = new SpiderSEOAdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES[ '__import' ], false), $this->getHTTPRequestSanitized($_POST[ '__import' ]));
