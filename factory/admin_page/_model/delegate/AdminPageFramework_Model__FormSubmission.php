...
class SpiderSEOAdminPageFramework_Model__FormSubmission extends SpiderSEOAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets)
    {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new SpiderSEOAdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData()
    {
        ...
        new SpiderSEOAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
