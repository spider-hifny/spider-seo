...
class SpiderSEOAdminPageFramework_Property_admin_page extends SpiderSEOAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability='manage_options', $sTextDomain='spider-seo')
    {
        ...
        $GLOBALS[ 'aSpiderSEOAdminPageFramework' ][ 'aPageClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aSpiderSEOAdminPageFramework', 'aPageClasses' ));
        $GLOBALS[ 'aSpiderSEOAdminPageFramework' ][ 'aPageClasses' ][ $sClassName ] = $oCaller;
