...
class SpiderSEOAdminPageFramework_Format_InPageTabs extends SpiderSEOAdminPageFramework_Format_Base {
    ...
    public function get()
    {
        ...
        foreach (( array ) $_aInPageTabs as $_sTabSlug => $_aInPageTab) {
            ...
            $_oFormatter = new SpiderSEOAdminPageFramework_Format_InPageTab($_aInPageTab, $this->sPageSlug, $this->oFactory);
