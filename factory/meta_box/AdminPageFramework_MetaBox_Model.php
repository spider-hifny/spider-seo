...
abstract class SpiderSEOAdminPageFramework_MetaBox_Model extends SpiderSEOAdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID=array( 'post' ), $sContext='normal', $sPriority='default', $sCapability='edit_posts', $sTextDomain='spider-seo')
    {
    ...
    {
        $_oMetaData = new SpiderSEOAdminPageFramework_MetaBox_Model___PostMeta($this->___getPostID(), $this->oForm->aFieldsets);
